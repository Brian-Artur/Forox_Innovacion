...
4. Fusionar una rama, a la que estamos ubicados.
...
3. Array asociativo.
4. dotJS 2012 - Brian Leroux - WTFJS
#### Git
...
2. El **Stash** : pequeño bolsillo
	1. Caso de uso
	2. Orden LIFO
	3. Utilidades del Stash
3. No hacer rebase si ya está en la nube.
...
4. Switch en pseudolenguaje.
5. Ciclos finitos vs ciclos no finitos.
6. Funciones
	1. Parámetros vs argumentos.
	2. Aridad fija vs aridad variable.
	3. Funciones que reciben objetos.
...
1. *007-tipos-datos-primitivos/*
	1. app_boolean.js
		...
		2. Números:
			1. positivo, negativo, cero y casting a boolean.
